...
- [x] 5.4 Add dashboard tests or browser verification proving settings can be saved and the UI shows connection status without exposing credential material.
