...
- [x] 2.4 Implement run, step, and event repository functions needed by the mock runtime lifecycle.
- [x] 2.5 Add persistence tests proving created goals and events survive database reopen.
...
- [x] 5.5 Implement start button using `POST /api/goals/:id/start`.
- [x] 5.6 Implement event timeline using `GET /api/goals/:id/events`.
- [x] 5.7 Verify the dashboard demo path works after browser refresh without dedicated run or step query APIs.
