...
- [x] 6.3 Run browser verification against the local dashboard using the Codex model path and confirm the provider setup still renders.
- [x] 6.4 Run `openspec validate refine-scope-vote-loop --strict`.
