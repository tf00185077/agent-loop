# supervisor-spec-approval

The Supervisor's stateful, backend-enforced semantic review of validated spec artifacts: review request packets, one durable decision per validated worker attempt, approval-gated review-merge, attempt-scoped approval invalidation, and restart rehydration.
