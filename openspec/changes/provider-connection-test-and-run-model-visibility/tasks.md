...
- [x] 1.3 Ensure mock and Claude Local saves do not trigger Codex Local connection tests
- [x] 1.4 Add dashboard/API tests covering auto-test success, auto-test failure, and no auto-test for non-Codex providers
