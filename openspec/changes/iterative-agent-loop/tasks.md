...
- [x] 4.3 Source planner memory from persisted steps each iteration (no provider session)
- [x] 4.4 Tests: multi-step advance, depth bound stops decomposition, step bound overrides planner, blocked terminal state
