# Conditional Integration Recovery Specification

## Purpose

Define backend-triggered, isolated, bounded Integrator recovery for verified
candidate-apply conflicts, including candidate attestation, mandatory fresh
Judge authority, and restart-safe failure handoff.
