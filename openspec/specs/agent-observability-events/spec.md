# agent-observability-events Specification

## Purpose

Define durable, sanitized agent observability events for provider liveness, command execution, progress, and future subtask activity.
